  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      ...
      <div className="mt-10 space-y-10 text-sm leading-7 text-choc-600">
        <section>
          <h2 className="text-base font-semibold text-choc-800">1. Personuppgiftsansvarig</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-base font-semibold text-choc-800">2. Vilka uppgifter vi samlar in</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-base font-semibold text-choc-800">3. Varför vi behandlar dina uppgifter</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-choc-800">4. Hur länge vi sparar uppgifter</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-base font-semibold text-choc-800">5. Delning av uppgifter</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-base font-semibold text-choc-800">6. Dina rättigheter</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-choc-800">7. Cookies</h2>
          <p className="mt-3">
