...
const quickLinks = [
  { href: "/services", label: "Behandlingar" },
...
const legalLinks = [
  ...
  { href: "/villkor", label: "Bokningsvillkor" },
];
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 flex gap-2.5">
              ...
              <SocialIcon href="https://google.com" label="Google recensioner">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3.5 text-sm">
              ...
              <li>
                <a href="mailto:kontakt@wellness.se" className="hover:text-white transition-colors">
                  kontakt@wellness.se
                </a>
              </li>
            </ul>
