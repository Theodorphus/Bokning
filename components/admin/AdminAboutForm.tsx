...
export default function AdminAboutForm({ content }: AdminAboutFormProps) {
  ...
  return (
    <div className="rounded-xl bg-white p-6 ring-1 ring-choc-200 border border-choc-200">
      <div className="mb-6">
        <h2 className="text-lg font-bold text-choc-800">Redigera om oss-sidan</h2>
        <p className="mt-1 text-sm text-choc-700">Uppdatera innehål på om oss-sidan</p>
      </div>
      ...
      <form action={formAction} className="space-y-6">
        ...
        {/* Subtitle */}
        <div>
          <label htmlFor="subtitle" className="block text-sm font-semibold text-choc-800 mb-2">
            Underrubrik
          </label>
          <textarea
            id="subtitle"
            ...
            placeholder="Underrubrik för om oss-sidan..."
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg px-4 py-3 text-sm text-choc-800 ring-1 ring-choc-200 focus:outline-none focus:ring-2 focus:ring-wood-400 bg-white resize-none"
            placeholder="Huvudtext för om oss-sidan..."
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg px-4 py-3 text-sm text-choc-800 ring-1 ring-choc-200 focus:outline-none focus:ring-2 focus:ring-wood-400 bg-white"
            placeholder="t.ex. /images/massage.png"
          />
        ...
        {state?.success && (
          <div className="rounded-lg bg-green-50 p-4 border border-green-200">
            <p className="text-sm font-medium text-green-800">Om oss-sidan uppdaterad!</p>
          </div>
        )}
        {state?.error && (
        ...
        >
          {pending ? "Sparar..." : "Spara om oss-sidan"}
        </button>
      </form>
    </div>
  );
